...
| `skills/` | 10 slash commands (`/neo:init`, `/neo:save`, `/neo:status`, `/neo:plan`, `/neo:review`, `/neo:map`, `/neo:train`, `/neo:gc`, `/neo:recall`, `/neo:evolve`). Each is a subdirectory with a `SKILL.md`. |
